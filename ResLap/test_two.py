...
from ResLap.reslap import Net
import os
from Lib.model_methods import test_model, test_multi_model
...
class Data_set():
    def __init__(self, numpy_test_path, test_path, output_path, output_numpy_path, ckpt,
                 mid_size_w, mid_size_j, output_size_w, output_size_j):
        self.numpy_test_path, self.test_path, self.output_path, self.ckpt = numpy_test_path, test_path, output_path, ckpt
        self.mid_size_w = mid_size_w
        self.mid_size_j = mid_size_j
...
if __name__ == "__main__":
    ...
    checkpoint = "/home/lthpc/Jianxin/SR_Models/ResLap/weights-10/EC/4/10km/ResLap_epoch_98.pth"
    ...
    output_path = "/home/lthpc/Jianxin/SR_Models/ResLap/output_image_10/"
    output_path = os.path.join(output_path, area)
    output_path = os.path.join(output_path, str(scale) + "km")
    output_numpy_path = "/home/lthpc/Jianxin/SR_Models/ResLap/output_numpy_10/"
    ...
    model = Net(num_channels=3, base_filter=16, num_residuals=10, input_size_w=input_size_w, input_size_j=input_size_j,
                mid_size_w=mid_size_w, mid_size_j=mid_size_j, output_size_w=output_size_w, output_size_j=output_size_j)
    args = Data_set(numpy_test_path, test_path, output_path, output_numpy_path, checkpoint, mid_size_w, mid_size_j,
