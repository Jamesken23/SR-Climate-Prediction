...
from ResLap.reslap_sim import Net
import os
...
if __name__ == "__main__":
    ...
    checkpoint = "/home/lthpc/Jianxin/SR_Models/ResLap/weights-10/DB/4/2km/ResLap_epoch_97.pth"
    ...
    args = Data_set(numpy_test_path, test_path, output_path, output_numpy_path, checkpoint, output_size_w,
                    output_size_j)
