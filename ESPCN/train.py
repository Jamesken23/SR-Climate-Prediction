...
if __name__ == "__main__":
    ...
    model = Net(num_channels=3, base_filter=16, upscale_factor=scale, output_size_w=output_size_w,
                output_size_j=output_size_j)
    Epoch = 100
    args = Data_set(Epoch, learning_rate, batch_size, train_path, val_path, dem_path, checkpoint, input_size_w,
                    input_size_j, output_size_w, output_size_j, split, True)

    args.model = model
    args.model_name = "ESPCN"
