...
if __name__ == "__main__":
    ...
    try:
        ...
        test_path = "/home/lthpc/Jianxin/SR_Models/test_data/3/2017-3/"
        output_path = "/home/lthpc/Jianxin/SR_Models/ESPCN/output_image/"
    ...
    checkpoint = "/home/lthpc/Jianxin/SR_Models/ESPCN/weights/DB/3/2km/ESPCN_epoch_50.pth"
    ...
    test_paths = "/home/lthpc/Jianxin/SR_Models/test_data/3/2017-3/"
    output_path = "/home/lthpc/Jianxin/SR_Models/ESPCN/output_image_one/"
    output_path = os.path.join(output_path, area)
    output_path = os.path.join(output_path, str(scale) + "km")
    output_numpy_path = "/home/lthpc/Jianxin/SR_Models/ESPCN/output_numpy_one/"
    ...
    model = Net(num_channels=3, base_filter=16, upscale_factor=scale, output_size_w=output_size_w, output_size_j=output_size_j)
