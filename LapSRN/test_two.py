...
if __name__ == "__main__":
    ...
    checkpoint = "/home/lthpc/Jianxin/SR_Models/LapSRN/weights/EC/4/10km/LapSRN_epoch_59.pth"
    ...
    output_path = "/home/lthpc/Jianxin/SR_Models/LapSRN/output_image_two/"
    output_path = os.path.join(output_path, area)
    output_path = os.path.join(output_path, str(scale) + "km")
    output_numpy_path = "/home/lthpc/Jianxin/SR_Models/LapSRN/output_numpy_two/"
